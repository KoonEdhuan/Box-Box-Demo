            ...
            modifier = Modifier
                ...
                .background(
                    brush = Brush.verticalGradient(
                        colors = listOf(Black,Green,Black,Black)
                    )
                )
                .padding(16.dp),
            ...
            Column(
                ...
                Row(
                    ...
                    if (countdown == null) {
                        ...
                        CountdownUnit(time = countdown?.days?.toString() ?: "0", unit = "Days")
                        CountdownUnit(time = countdown?.hours?.toString() ?: "0", unit = "Hours")
                        CountdownUnit(time = countdown?.minutes?.toString() ?: "0", unit = "Minutes")
                    }
                }
...
fun CountdownUnit(time: String, unit: String) {
    Column(horizontalAlignment = Alignment.CenterHorizontally) {
        Text(text = time, color = LightGreen, fontSize = 36.sp, fontWeight = FontWeight.Bold)
